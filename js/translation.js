...
var translationsRU = {
    ...
    MAIN_PAGE: {
        ...
        TEXT                   : {
            ...
            PART_3: "К участию в конференции допускаются законченные научно-исследовательские работы, соответствующие тематике конференции и имеющие актуальное теоретическое и практическое значение для развития технической отрасли науки."
        },
        LANGUAGES_DESCRIPTION  : "Официальные языки конференции: русский, английский",
        ORGANIZER              : "Организатор:",
        DEPARTMENT             : "кафедра",
        DEPARTMENT_NAME        : "\"Техническая механика и детали машин\"",
        INSTITUTE              : "\"Институт электронной техники и машиностроения\"",
        PARTICIPANT_COUNT      : "Количество участников",
        INFORMATION_MAIL       : "Информационное письмо",
...
var translationsEN = {
    ...
    MAIN_PAGE: {
        ...
        TEXT                   : {
            ...
            PART_3: "The conference allowed the completed research projects, conferences and relevant topics of relevance theoretical and practical significance for the development of the technical branch of science."
        },
        LANGUAGES_DESCRIPTION  : "Official languages: Russian, English",
        ORGANIZER              : "Organizer",
        DEPARTMENT             : "Department",
        DEPARTMENT_NAME        : "\"Technical mechanics and machine \"",
        INSTITUTE              : "\"Institute of Electronic Engineering and Mechanical Engineering\"",
        PARTICIPANT_COUNT      : "Number of participants",
        INFORMATION_MAIL       : "Information mail",
